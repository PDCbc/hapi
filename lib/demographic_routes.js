      ...
      auth.verifyAuth( cookie,
        function(err, body){
          ...
          else if(body.clinic !== req.params.clinic && body.clinician !== req.params.clinician)
          {
            ...
            logger.warn('req.param.clinic: ' + req.param.clinic);
            logger.error('*****************');
            logger.success('body.clinician: ' + body.clinician);
            logger.success('req.params: ' + req.params.clinician);
...
function fetch_clinician_demographic_data(req, res, data, execution_ids)
{
  ...
  console.log('clinic: ' + req.params.clinic);

  console.log('clinician: ' + req.params.clinician);
