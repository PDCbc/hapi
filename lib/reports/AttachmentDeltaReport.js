...
var logger  = require('../logger').Logger("AttachmentDeltaReport", 1); 
var util    = require("util"); 
var Report  = require('./Report')

/**
* A specific AttachmentDeltaReport object that is meant to produce 
...
* 
* The relationship between the Report and AttachmentDeltaReport objects is 
...
*       methods/variables that are accessible to the AttachmentDeltaReport object, but should not 
*       be made publicly accessible. 
* 
* @return {Object} - an object that contains public functions and variables.
*/
var AttachmentDeltaReport = function(shortName, name, proc){
...
module.exports = {AttachmentDeltaReport : AttachmentDeltaReport};