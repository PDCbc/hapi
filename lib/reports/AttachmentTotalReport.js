...
var logger  = require('../logger').Logger("AttachmentTotalReport", 1); 
var util    = require("util"); 
var Report  = require('./Report')

/**
* A specific AttachmentTotalReport object that is meant to produce 
...
* the specific attachment tabular reporting requirements. T
* 
* This report hardcodes the queries that the report depends on.
* 
* The relationship between the Report and AttachmentTotalReport objects is 
...
*       methods/variables that are accessible to the AttachmentTotalReport object, but should not 
*       be made publicly accessible. 
* 
* @return {Object} - an object that contains public functions and variables.
*/
var AttachmentTotalReport = function(shortName, name, proc){
    ...
    //Report object.
    //
    var that = Report.Report(shortName, name, ["PDC-1738"], proc);
...
module.exports = {AttachmentTotalReport : AttachmentTotalReport};