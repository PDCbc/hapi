    ...
    * 
    ...
    var generateCSVReport = function (data) {
        ...
        for (var k in data['PDC-1178'].anonymous) {
            ...
            num = data['PDC-1178'].anonymous[k][data['PDC-1178'][f].length - 1]["aggregate_result"]["numerator"];
            den = data['PDC-1178'].anonymous[k][data['PDC-1178'][f].length - 1]["aggregate_result"]["denominator"];

            s += num + ",";
            s += ((num / den) * 100) + ",";

            num = data['PDC-053'].anonymous[k][data['PDC-053'][f].length - 1]["aggregate_result"]["numerator"];
            den = data['PDC-053'].anonymous[k][data['PDC-053'][f].length - 1]["aggregate_result"]["denominator"];

            s += num + ",";
            s += ((num / den) * 100) + ",";

            num = data['PDC-054'].anonymous[k][data['PDC-054'][f].length - 1]["aggregate_result"]["numerator"];
            den = data['PDC-054'].anonymous[k][data['PDC-054'][f].length - 1]["aggregate_result"]["denominator"];
