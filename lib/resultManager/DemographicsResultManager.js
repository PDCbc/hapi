...
function DemographicsResultManager(id, data, proc) {
    ...
    proc.supportedGenders = ['male', 'female', 'undifferentiated', 'undefined'];
    ...
    var generateResult = function () {
        ...
        finalResult.clinician.push(clinician);
        finalResult.group.push(group);
        finalResult.network.push(network);
