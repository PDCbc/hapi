...
function RatioResultManager( id, data, proc ){
    ...
    */
    ...
    /**
    * Combines all of the results from the input into numerator/denominator pair.
    *
    ...
    var reduce = function(input){
        ...
        for( var i = 0; i < input.length; i++ ){
            ...
            try{
                ...
                logger.error("Failed to reduce based on numerator/denominator pair, ignoring this pair.", "reduce()"); 
    ...
    */
    ...
    var getFormattedData = function(next){
        ...
        next(proc.generateResult(that.getNetwork()));
