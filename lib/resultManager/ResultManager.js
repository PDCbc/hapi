 ...
 *   object.
 */
function ResultManager(id, data, init, proc) {
     ...
     *   method that must be implemented by the sub-object.
     */
    var getGroup = function (initiative) {

        var toReturn    = [];
        var input       = getData();
	initiative = initiative || 'PPhRR';
	
        var activeGroup = proc.groups.findGroup(id, initiative);
