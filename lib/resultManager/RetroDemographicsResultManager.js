 ...
 * This object extends the functionality in the concrete class DemographicsResultManager.
 *
 ...
 *   object.
 */
function RetroDemographicsResultManager(id, data, init, proc) {
    ...
    var that = DemographicsResultManager(id, data, init, proc);
    ...
    var generateResult = function (input, next) {
        ...
        try {
            ...
            for (var i = 0; i < proc.resultManagers.length; i++) {
                ...
                finalResult.processed_result.clinician.push(tmpResult.processed_result.clinician[0]);
                finalResult.processed_result.group.push(tmpResult.processed_result.group[0]);
                finalResult.processed_result.network.push(tmpResult.processed_result.network[0]);
