...
function routes(next, data) {
    ...
    router.get('/api',
        ...
        function (req, res) {
/**** TODO: 4-001 We cannot really guarantee that `title` will be unique.
It might be better to include a unique id, like `_id`, in select and query based
on that. This will require further changes. ****/
