  ...
  router.get('/api/processed_result',
    ...
    router.get(
        ...
        function ( req, res ){
            ...
            logger.info("processing request for: "+ req.params.title + " for clinician : "+req.session.user.clinician);
            ...
            data.models.query
                ...
                function (err, queries) {
                    ...
                    if( !exe ){
                        ...
                        logger.error("No query executions were found, returning an error.");
                        res.statusCode = 500;
                        res.json({"error" : "Error, there are no query executions"});
                        return; 
                    ...
                    rrm.getFormattedData( 
                        function( result ){ 
                            ...
                            logger.success(util.inspect(result,false,null));
