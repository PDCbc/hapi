            ...
            data.models.query.find({title: "PDC-001"}).exec(
                function (err, result) {
                    ...
                    try {
                        ...
                        var x = DemographicsResultManager(req.session.user.clinician, JSON.parse(JSON.stringify(exe)), "Attachement");
                        ...
                        x.getFormattedData(function (data) {
                            ...
                            try {
                                ...
                                if (data) {
                                    ...
                                    data.display_name = result[0].display_name;

                                    try {

                                        data.latest = result[0].executions[result[0].executions.length - 1].time;
                                    ...
                                    if (result[0].title === "PDC-1740") {
                                        ...
                                        data.xAxisTitle = "Number of Patients";
