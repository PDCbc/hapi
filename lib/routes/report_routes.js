...
var attachmentDelta = require("../reports/AttachmentDeltaReport");
var attachmentTotal = require("../reports/AttachmentTotalReport");
...
function report_routes(next, data){
    ...
    var reports = [
        ...
        attachmentTotal.AttachmentTotalReport("attachment-total-report", "Attached Patients Report (Total)"),
        attachmentDelta.AttachmentDeltaReport("attachment-delta-report", "Attached Patients Report (Delta)")
    ...
    router.route('/:title').get(
        ...
        function(req, res){
            ...
            try{
                ...
                logger.error("/report/title caught an error: "+ util.inspect(e, false, null));
                res.status(500);
                return res.send();
