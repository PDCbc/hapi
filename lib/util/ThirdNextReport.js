    ...
    var getClinicLevelReport = function (data) {
        ...
        for (c in clinics) {
            ...
            for (var e = 0; e < clinics[c].length; e++) {
                ...
                s += clinics[c][e].average + ",";
                s += clinics[c][e].min + ",";
                s += clinics[c][e].max + ",";
                s += (clinics[c][e].coeff * 100) + ",";
            }
            s += "\n";
        }
        ...
        for (e = 0; e < totals.length; e++) {
            ...
            s += "-,";
            s += (totals[e].min / totals[e].count) + ",";
            s += (totals[e].max / totals[e].count) + ",";
            s += (totals[e].average / totals[e].count) + ",";
            s += (totals[e].coeff / totals[e].count) + ",";
